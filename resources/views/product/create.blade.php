        ...
        @csrf
            ...
            {{-- <div class="form-row"> --}}
                <div class="form-group">
                    ...
                    <input type="text" name="condition" @error('condition') is-invalid @enderror value="{{ old('condition') }}" placeholder="Product condition" class="form-control name" autocomplete="off" >
                    @error('condition')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
